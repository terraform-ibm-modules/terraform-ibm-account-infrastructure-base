...
module "account_infrastructure_base" {
  ...
  # trusted profile
  trusted_profile_unique_identifier  = var.trusted_profile_unique_identifier == null ? try("${var.prefix}-trusted-profile", "projects-trusted-profile") : var.trusted_profile_unique_identifier
